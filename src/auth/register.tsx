...
export function useRegister() {
        ...
        content: (
          <div className="flex flex-col gap-3 p-5 w-fit">
            ...
            <p className="text-center">
              An verification E-Mail has been sent to {userMial}. Click on the
              link in there and your account will be ready to go!
            </p>
            <button
  ...
  return useCallback(
    (registerOptions: EmailProviderRegisterOptions, redirectUrl: string) => {
