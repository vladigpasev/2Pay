...
function CompanyInfo() {
    ...
    const companyData = {
        ...
        description: 'Company A specializes in advanced tech solutions. With over a decade in the industry, we strive to innovate and lead.Company A specializes in advanced tech solutions. With over a decade in the industry, we strive to innovate and lead.',
    };
        ...
        <div className='flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-r from-[#00a54d20] to-secondary'>
            <div className="w-full md:w-1/2 p-8 flex flex-col items-center justify-center border-r-2 md:border-b-0 border-[#00a54d56]">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-md md:text-lg text-description max-w-2xl mx-auto">
