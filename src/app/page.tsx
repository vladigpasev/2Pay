      ...
      <section className="">
        ...
        <section className="for-businesses flex flex-col min-[883px]:flex-row mx-10 min-[883px]:ml-28 items-center justify-center gap-12 mb-28">
          <section className="text">
            ...
            <p className="text-xl mb-14">2Pay is the most trusted payment system in the business. The trust is based on our stable platform, secure transactions, and easy integration into every website and software possible.</p>
            <section className="flex items-center justify-center">
              <section className="btn btn-primary">Set your business at <Image src={logo} alt='' className='w-20'></Image></section>
            </section>
          </section>
        ...
        <section className="for-clients flex flex-col min-[883px]:flex-row-reverse mx-10 min-[883px]:ml-28 items-center justify-center gap-12">
          <section className="text">
            ...
            <p className="text-xl mb-14">The reason why milions of people 2Pay as their payment system is our propriety towards them. Our clients rely on us for fast eand easy payments, everyday from every point on Planet Earth.</p>
            <section className="flex items-center justify-center">
              <section className="btn btn-primary">Be a client of <Image src={logo} alt='' className='w-20'></Image></section>
            </section>
          </section>
        ...
        <section className="crypto-pay bg-gradient-to-b from-[#00a54c] to-[#006b32] flex flex-col justify-center items-center mt-10">
          <section className="text-neutral mx-10 md:mx-32">
            <p className="text-3xl min-[450px]:text-6xl flex items-center justify-center py-8">Crypto <Image src={logo} alt='' className='w-28 min-[450px]:w-44'></Image></p>
            <p className="text-xl md:max-w-[700px] text-center">Our newest and most special feature for those, who want their payments to be fully encrypted! Crypto2Pay offers not just payments in crypto. It offers 100% security of the payments, and also full encription, so no violators may track your flow of money.</p>
