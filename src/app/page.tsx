          ...
          <div className="hero-content flex-col lg:flex-row gap-8">
            ...
            <div className="w-2/4 max-md:w-full">
              ...
              <p className="py-6 text-base-content">
                We want <strong>not just</strong> to let you be happy, but make
                you <strong className="text-accent">happy</strong>. <i>How</i>{" "}
                are we doing this? We will give you{" "}
                <strong>
                ...
                . Again here comes the question <i>how</i>? By letting you{" "}
                <strong>chat</strong>
                with friends, play <strong>board games</strong>, be part of our
                daily
                <strong>games/contests</strong> and just relexing in our{" "}
                <strong className="text-accent">chillll</strong> zone where you
                will get a massage by our proffesional japanese masseur.
              </p>
            </div>
          </div>
        </main>
