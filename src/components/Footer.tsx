...
export const Footer = () => (
  <footer className='footer p-10 bg-base-200 text-base-content'>
    <aside>
      <Link href='/'>
        <Image src={logo} alt='' className='w-3/5'></Image>
      </Link>
      <p>
        2Pay Inc.
        <br />
    ...
    <nav>
      ...
      <Link href='/#forBusiness' className='link link-hover'>
        For Businesses
      </Link>
      <Link href='/#fairOurClients' className='link link-hover'>
        For Clients
      </Link>
      <Link href='/#crypto2pay' className='link link-hover'>
        Crypto2Pay
      </Link>
    </nav>
    <nav>
